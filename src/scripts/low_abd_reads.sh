...
if [ ! -f $assembly_dir/contigs.megahit_cut$covcut.low_abd.fq ]; then
    $BINDIR/../bin/extract_unmapped -b $assembly_dir/contigs.megahit.name_sorted.bam -c $assembly_dir/contigs.megahit.depth -f $covcut -o $assembly_dir/contigs.megahit_cut$covcut
