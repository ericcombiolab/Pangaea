...
def main():
    ...
    # metaphalan db path
    parser.add_argument("-m", "--metaphlan_db", type=str, default="metaphlan_db", help="path to metaphlan db (default metaphlan_db)")
    ...
    parser.add_argument("-la", "--low_assembler", type=str, default="megahit", help="local assembly method (spades or megahit)")
